...
<body>
	...
	<div id="main">
		<div id="main_1">
			<h1>MY CODE SHEAR</h1>
			<form action="joinProc.jsp" method="post" onsubmit="return updateCheck()">
				...
				<p id="text"><b>ID</b></p>
				<input type="text" id="data1" name="m_id" class="id">
				<input type="button" value="D-Check" id="pk_btn1">
				...
				<input type="submit" value="JOIN" id="data_btn">
			</form>
		</div>
	</div>
</body>
