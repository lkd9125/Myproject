...
<meta charset="UTF-8">
<title>질문게시판 출력(Study Share)</title>   
</head>
<body>
	...
	<section>
		<div id="post" class="su">
			...
			<div id="box">
				<h1 id="title">제목
					: ${empty post.q_title ? '데이터 없음' : post.q_title}</h1>
				<fieldset id="text">
					<p id="text1" >${empty post.q_text ? '데이터 없음' : post.q_text}</p>
				</fieldset>
				<div id="buttonbox">
						...
						<tbody>
							<tr>
								<td><input type="text" class="form-control"
									placeholder="글 제목" name="qsTitle" maxlength="50"
									value="${post.q_title}"></td>
							</tr>
							<tr>
								<td><textarea class="form-control" placeholder="글 내용"
										name="qsContent" maxlength="2048" ></textarea></td>
							</tr>
						</tbody>
					</table>
					<!-- 글쓰기 버튼 생성 -->
...
String str3 = (String) session.getAttribute("nickname");%>
	...
	$("#bt1").click(function() {
		location.href = "update1_q?code=${post.q_num}";
	});
	$("#bt2").click(function() {
		location.href = "delete11_q?code=${post.q_num}";
	});
